  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" href="indexabs.php">Absen</a>
      </li>
    </ul>
    </form>
  </div>
...
<a href="createabs.php">Tambah Data</a>
<br>
<a href="printabs.php" target="_blank">Cetak Data</a>
<br><br>
<table border="1">
<thead>
<tr>
...
<td>
<a name="edit" id="edit"
href="editabs.php?nim=<?=$data->nim ?>">Edit</a>
<a name="hapus" id="hapus"
href="prosesabs.php?nim=<?=$data->nim ?>">Delete</a>
</td>
</tr>
<?php endforeach;
} else{ ?>
